...
print(parcoursInfixe(parfait(3)))

def peigneGauche(h):
  assert type(h) == int and h>=0, "La hauteur est un entier positif"
  if h == 0:
    return None
  return Noeud(peigneGauche(h-1),h,None)

print(parcoursInfixe(peigneGauche(3)))

def peigneDroit(h):
  assert type(h) == int and h>=0, "La hauteur est un entier positif"
  if h == 0:
    return None
  return Noeud(None,h,peigneDroit(h-1))

print(parcoursInfixe(peigneDroit(3)))